...
Before Starting `dnsmasq-setup`, make sure you are not running any other software that is listening
on ports 53, 80, 443 and 19322.
This will cause the command to fail. To allow the script to modify your systems DNS configuration,
